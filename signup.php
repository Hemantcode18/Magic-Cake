        ...
        <div class=" container">
            ...
            <div class="col-lg-12">
                <div class="class__form">
                    ...
                    ?>
                    <form action="check_signup.php" name="Signup" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <label>First Name</label>
                                        <input class="shadowss" type="text" name="fname" onblur="namef()" placeholder="Enter first name" required>
                                        <span id="fname"></span>
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <span id="ph"></span>
                                <label>Country</label>
                                <input type="text" name="country" onblur="country1()" placeholder="Enter country" required>
                                <span id="country"></span>
                                <label>State</label>
                                <input type="text" name="state" onblur="state1()" placeholder="Enter state" required>
                                <span id="state"></span>
                                <label>City</label>
                                <input type="text" name="city" onblur="city1()" placeholder="Enter city" required>
                                <span id="city"></span>
                                <label>Image</label><br>
                                <input type="file" name="image" id="file" hidden="true">
                                <label class="site-btn rounded shadow" style="cursor:pointer; background-color:#fd7e14" for="file">Upload profile</label>
                            </div>
                        </div>
