    ...
    ?>
      ...
      <div class="search_res">
          ...
          <div class="row">
              ...
              <?php
                ...
                if (isset($_POST['search'])) {
                    ...
                    $query4 = "select product.*,category.category_id,category_name,subcategory.subcategory_id,subcategory_name from category,subcategory,product where category.category_id='$category_id' and product.subcategory_id='$subcategory_id' and product.subcategory_id=subcategory.subcategory_id and product.product_name like '%$search%' limit $start_from,$num_per_page";
                } else {
                    $query4 = "select product.*,category.category_id,category_name,subcategory.subcategory_id,subcategory_name from category,subcategory,product where category.category_id='$category_id' and product.subcategory_id='$subcategory_id' and product.subcategory_id=subcategory.subcategory_id limit $start_from,$num_per_page";
                }
          ...
          <?php
            ...
            $query4 = "select * from product where subcategory_id='$subcategory_id' and status='active'";
